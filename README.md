# Conductor QuickBooks Desktop API library

[![PyPI version](https://img.shields.io/pypi/v/conductor-py.svg)](https://pypi.org/project/conductor-py/)

The Conductor QuickBooks Desktop library provides convenient access to the Conductor REST API from any Python 3.8+
