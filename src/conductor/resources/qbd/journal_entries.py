...
from ...types.qbd.qbd_journal_entry import QbdJournalEntry
...
class JournalEntriesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          is_amounts_entered_in_home_currency: Indicates whether the amounts in this journal entry were entered in the
            ...
            body=maybe_transform(
                {
                    ...
                    "is_amounts_entered_in_home_currency": is_amounts_entered_in_home_currency,
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncCursorPage[QbdJournalEntry]:
        """
        ...
        return self._get_api_list(
            "/quickbooks-desktop/journal-entries",
            page=SyncCursorPage[QbdJournalEntry],
            options=make_request_options(
...
class AsyncJournalEntriesResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[QbdJournalEntry, AsyncCursorPage[QbdJournalEntry]]:
        """
        Returns a list of journal entries.
        ...
        return self._get_api_list(
            "/quickbooks-desktop/journal-entries",
            page=AsyncCursorPage[QbdJournalEntry],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
