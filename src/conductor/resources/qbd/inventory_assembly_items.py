    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          class_ids: Filter for inventory assembly items of this class or classes. A class is a way
              end-users can categorize inventory assembly items in QuickBooks.
