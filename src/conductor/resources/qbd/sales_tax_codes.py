    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          name_contains: Filter for sales-tax codes whose `name` contains this substring. If you use this
              parameter, you cannot use `nameStartsWith` or `nameEndsWith`.

          name_ends_with: Filter for sales-tax codes whose `name` ends with this substring. If you use
          ...
          name_starts_with: Filter for sales-tax codes whose `name` starts with this substring. If you use
