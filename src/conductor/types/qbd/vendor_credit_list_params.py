...
class VendorCreditListParams(TypedDict, total=False):
    ...
    ids: List[str]
    """
    Filter for specific vendor credits by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    Defaults to `false`. For example, a payment linked to the corresponding vendor
    credit.
    """
    ...
    """
    Filter for vendor credits whose `refNumber` is greater than or equal to this
    ...
    """Filter for specific vendor credits by their ref-number(s), case-sensitive.
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """Filter for vendor credits whose `refNumber` is less than or equal to this value.
    ...
    """
    Filter for vendor credits created on or after this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for vendor credits created on or before this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for vendor credits updated on or after this date and time, in ISO 8601
    ...
    """
    Filter for vendor credits updated on or before this date and time, in ISO 8601
    format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the time
    is assumed to be 23:59:59 of that day.
    """

    vendor_ids: Annotated[List[str], PropertyInfo(alias="vendorIds")]
    """Filter for vendor credits received from these vendors.

    These are the vendors who owe the QuickBooks user money.
    """
