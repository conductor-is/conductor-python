...
class QbdBillPaymentCreditCard(BaseModel):
    id: str
    """The unique identifier assigned by QuickBooks to this bill payment credit card.
    ...
    amount: Optional[str] = None
    """
    The monetary amount of this bill payment credit card, represented as a decimal
    string.
    """

    amount_in_home_currency: Optional[str] = FieldInfo(alias="amountInHomeCurrency", default=None)
    """
    The total amount for this bill payment credit card converted to the home
    ...
    """The bill(s) paid by this bill payment credit card."""

    created_at: str = FieldInfo(alias="createdAt")
    """
    The date and time when this bill payment credit card was created, in ISO 8601
    ...
    """The bill payment credit card's currency.
    ...
    """
    The custom fields for the bill payment credit card object, added as user-defined
    ...
    **IMPORTANT**: For checks, this field is the check number.
    ...
    """
    The date and time when this bill payment credit card was last updated, in ISO
