...
__all__ = ["BillPaymentCreditCardListParams"]


class BillPaymentCreditCardListParams(TypedDict, total=False):
    ...
    """Filter for bill payment credit cards associated with these accounts."""
    ...
    ids: List[str]
    """
    Filter for specific bill payment credit cards by their QuickBooks-assigned
    unique identifier(s).
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """Filter for bill payment credit cards whose `refNumber` contains this substring.
    ...
    """Filter for bill payment credit cards whose `refNumber` ends with this substring.
    ...
    """
    Filter for bill payment credit cards whose `refNumber` is greater than or equal
    ...
    """
    Filter for specific bill payment credit cards by their ref-number(s),
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """
    Filter for bill payment credit cards whose `refNumber` starts with this
    ...
    """
    Filter for bill payment credit cards whose `refNumber` is less than or equal to
    ...
    """
    Filter for bill payment credit cards created on or after this date, in ISO 8601
    format (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for bill payment credit cards created on or before this date, in ISO 8601
    format (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for bill payment credit cards updated on or after this date and time, in
    ...
    """
    Filter for bill payment credit cards updated on or before this date and time, in
    ISO 8601 format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD),
