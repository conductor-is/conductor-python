...
class InventoryItem(BaseModel):
    ...
    """The barcode value associated with this inventory-item."""

    class_: Optional[Class] = FieldInfo(alias="class", default=None)
    """
    The class associated with this inventory-item, used to categorize objects or
    ...
    version: str
    """
    A version identifier for this inventory-item, which changes each time the object
