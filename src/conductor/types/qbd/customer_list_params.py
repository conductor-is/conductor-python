...
class CustomerListParams(TypedDict, total=False):
    ...
    """Filter for customers with the specified QuickBooks-assigned unique
    identifier(s).
    ...
    """Filter for customers with this full-name or full-names.

    Like `id`, a full-name is a unique identifier for a customer, and is created by
    prefixing the customer's name with the names of each ancestor. If your request
