...
class JournalEntryListParams(TypedDict, total=False):
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """
    Filter for journal entries created on or after this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for journal entries created on or before this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for journal entries updated on or after this date and time, in ISO 8601
    ...
    """
    Filter for journal entries updated on or before this date and time, in ISO 8601
    format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the time
