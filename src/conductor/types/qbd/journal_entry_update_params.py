...
class JournalEntryUpdateParams(TypedDict, total=False):
    ...
    """
    The current revision number of the journal entry object you are updating, which
    ...
    is_amounts_entered_in_home_currency: Annotated[bool, PropertyInfo(alias="isAmountsEnteredInHomeCurrency")]
    """
