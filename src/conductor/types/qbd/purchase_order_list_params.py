...
class PurchaseOrderListParams(TypedDict, total=False):
    ...
    ids: List[str]
    """
    Filter for specific purchase orders by their QuickBooks-assigned unique
    identifier(s).
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    Defaults to `false`. For example, a payment linked to the corresponding purchase
    order.
    """
    ...
    """
    Filter for purchase orders whose `refNumber` is greater than or equal to this
    ...
    """Filter for specific purchase orders by their ref-number(s), case-sensitive.
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """Filter for purchase orders whose `refNumber` is less than or equal to this
    value.
    ...
    """
    Filter for purchase orders created on or after this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for purchase orders created on or before this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for purchase orders updated on or after this date and time, in ISO 8601
    ...
    """
    Filter for purchase orders updated on or before this date and time, in ISO 8601
    format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the time
