...
__all__ = ["SalesReceiptListParams"]


class SalesReceiptListParams(TypedDict, total=False):
    ...
    ids: List[str]
    """
    Filter for specific sales receipts by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for sales receipts whose `refNumber` is greater than or equal to this
    ...
    """Filter for specific sales receipts by their ref-number(s), case-sensitive.
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """Filter for sales receipts whose `refNumber` is less than or equal to this value.
    ...
    """
    Filter for sales receipts created on or after this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for sales receipts created on or before this date, in ISO 8601 format
    (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for sales receipts updated on or after this date and time, in ISO 8601
    ...
    """
    Filter for sales receipts updated on or before this date and time, in ISO 8601
    format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the time
