...
class SubtotalItemListParams(TypedDict, total=False):
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """
    Filter for subtotal items whose `name` is alphabetically greater than or equal
    to this value.
    """
    ...
    **IMPORTANT**: If you include this parameter, QuickBooks will ignore all other
    ...
    """
    Filter for subtotal items whose `name` is alphabetically less than or equal to
    this value.
    """
    ...
    """
    Filter for subtotal items updated on or after this date and time, in ISO 8601
    ...
    """
    Filter for subtotal items updated on or before this date and time, in ISO 8601
    format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the time
