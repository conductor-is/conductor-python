...
class InvoiceListParams(TypedDict, total=False):
    ...
    """
    Filter for invoices from this account (e.g., accounts receivable, accounts
    payable).
    """
    ...
    customer_id: Annotated[Union[str, List[str]], PropertyInfo(alias="customerId")]
    """Filter for invoices from this customer."""
    ...
    For example, a payment linked to an invoice.
    """
