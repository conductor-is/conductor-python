...
from .qbd_credit_card_charge import QbdCreditCardCharge

__all__ = ["CreditCardChargeListResponse"]


class CreditCardChargeListResponse(BaseModel):
    data: List[QbdCreditCardCharge]
