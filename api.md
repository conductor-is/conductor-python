...
- <code title="post /end-users/{id}/request/{integrationSlug}">client.end_users.<a href="./src/conductor/resources/end_users.py">passthrough</a>(integration_slug, \*, id, \*\*<a href="src/conductor/types/end_user_passthrough_params.py">params</a>) -> <a href="./src/conductor/types/end_user_passthrough_response.py">EndUserPassthroughResponse</a></code>
